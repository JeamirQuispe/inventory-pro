...
productRoutes.post("/", canManageCatalog, asyncHandler(productController.create));
productRoutes.put("/:id", canManageCatalog, asyncHandler(productController.update));
productRoutes.delete("/:id", adminOnly, asyncHandler(productController.remove));
